    ...
    <footer className="bg-brand-green-dark text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Col 1 — Brand */}
          <div>
            <img src="/images/logo-white.png" alt="Tubertico" className="h-10 w-auto mb-2" />
          ...
          <div>
            <h3 className="font-semibold text-white mb-4">{t('footer.certs_title')}</h3>
              ...
              {certifications.map((cert) => (
                <div key={cert.name} className="flex items-center gap-3">
                  <img
                    src={cert.logo}
                    alt={cert.name}
                    className="h-10 w-auto object-contain bg-white rounded p-1 opacity-90"
                  />
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-white/50">
